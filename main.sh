...
sbatch -p preemptable --array=1-2 --nodes=1 --ntasks-per-node=30 --time=24:00:00 --mem=180G --job-name=s1000 \
                      --mail-type=END,FAIL --mail-user=sjennes@emory.edu --export=ALL,SIMNO=1000,NETSIZE=25 sh/runR.sh "03-burnin1-simMin"
