...
sbatch -p preemptable --array=1-5 --nodes=1 --ntasks-per-node=30 --time=24:00:00 --mem=180G --job-name=s1000 \
                      --mail-type=END,FAIL --mail-user=sjennes@emory.edu --export=ALL,SIMNO=1000,NETSIZE=25 \
